...
from langchain.proms import PromptTemplate
...
def get_text_chunks(text):
    text_splittter= RecursiveCharacterTeextSplitter(chunk_size=10000, chunk_overlap=1000)
